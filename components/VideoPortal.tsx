...
export default function VideoPortal() {
  ...
  return (
    <section ref={containerRef} className="relative z-20 h-[100lvh] md:h-screen w-full bg-[#FAF7F2] flex items-center justify-center overflow-hidden mt-0 md:mt-[15vh]">
