    ...
    >
      ...
      >
        {sourceCards.map((card, index) => (
          <div 
            key={card.id} 
            className={`source-card relative w-[100vw] md:w-[52vw] h-[60lvh] md:h-[65vh] flex-shrink-0 flex flex-col justify-end overflow-hidden group transition-all duration-700 mb-8 md:mb-0 bg-slate-900 ${
